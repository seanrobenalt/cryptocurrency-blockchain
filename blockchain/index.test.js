...
describe('Blockchain', () => {
  ...
  describe('isValidChain()', () => {
    ...
    describe('when the chain starts with the genesis block and has multiple blocks', () => {
      beforeEach(() => {
        blockchain.addBlock({ data: 'Blueberries' });
      ...
      describe('and the chain contains a block with an invalid field', () => {
        it('returns false', () => {
          blockchain.chain[2].data = 'some-hacker-data';
  ...
  describe('replaceChain()', () => {
    ...
    describe('when the new chain is longer', () => {
      beforeEach(() => {
        newChain.addBlock({ data: 'Blueberries' });
        newChain.addBlock({ data: 'Strawberries' });
        newChain.addBlock({ data: 'Bananas' });
      });

      describe('and the chain is invalid', () => {
        beforeEach(() => {
          newChain.chain[2].hash = 'some-hacked-hash';
